<template>
    <div>
        <div id="smallCreate" @click="hideBox()">
            {{formStacked}}
            <form action="">
                <div class="row">
                    <h3 style="text-align: center">创建小课程</h3>
...
<script>
    import categories from "../../../components/ztree/categories.vue"
    export default{
       data () {
            return{
                //需要提交的数据
        ...
        created () {
            ...
            $.get("/course/independent/retrival", function (data) {
                this.ajax.retrivalData = JSON.parse(data).msgObject;
                 console.log(this.ajax.retrivalData);
            });
            //获取“学年”数据
